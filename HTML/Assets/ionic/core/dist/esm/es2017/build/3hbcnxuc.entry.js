...
import { c as transition } from './chunk-19910bac.js';
...
class RouterOutlet {
    ...
    async componentDidLoad() {
        this.gesture = (await import('./chunk-267dafff.js')).createSwipeBackGesture(this.el, this.queue, () => !!this.swipeHandler && this.swipeHandler.canStart(), () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
