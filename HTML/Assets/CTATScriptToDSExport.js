...
var PT = null;
var ChosenUI;
var interfaceFilePath="fractionAddition.html";
var elts = [];
var g = null;
    ...
    assocRulesListener =
    {
      processCommShellEvent: function(evt, msg)
      {
        ...
        if(msg.getProperty("TraceOutcome")=="Correct Action")
        {
          ...
          currentnode=g.getLinkByID(5).getNextNode();
        }
        ...
        if(highlightedge==null && selectMode=="Demonstrate")
        {
          ...
          var nod = new CTATExampleTracerNode(addNodeId);
          g.addNode(nod);
          var edg = new CTATExampleTracerLink(addEdgeId, currentnode.id(), addNodeId);
          g.addLink(edg);
          currentnode.addOutLink(edg);
        }
